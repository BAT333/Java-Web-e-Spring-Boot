...
public class CardConfig {
    @Bean
    public RepositoryCardJPA cardJPA(CardRepository repositoryCard, CardEntityMapper entityMapper){
        return new RepositoryCardJPA(repositoryCard,entityMapper);
    }
    @Bean
    ...
    @Bean
    public FindCard card (RepositoryCard repositoryCard){
        return new FindCard(repositoryCard);
    }
    @Bean
